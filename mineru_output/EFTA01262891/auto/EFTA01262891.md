...
The person or propery to be searched, described above, is believed to conceal (identiy the person or deseribe the propery to be seized):

See Attachment A

The search and seizure are related to violation(s) of (inser stantory citarions):
...
in the daytime 6:00 a.m. to 10 p.m. a an  in thy r nig as eoabecaseas e established.
...
Upon ts reu, this warant and entoy shul e fil nder se y heCler of theCou.

USMJ Initials

I find that immediate notification may have an adverse result isted in 18 U..C. 2705 (except for delay of trial), and authorize the officer executing this warrant to delay notice to the person who, or whose property, will be searched or seized (check the appropriate box) for days (not to exceed 30).

until, the facts justifying, the later specific date of

Date and time issued:77-1911.33P.M. Judge % signature

City and state:New York, NY

Hon. Barbara Moses, U.S. Magistrate Judge SDNYGM\_00000134 Printed name and title

AO 93 (SDNY Rev. 01/17) Search and Seizure Warrant(Page 2)

<table><tr><td rowspan=1 colspan=3>Return</td></tr><tr><td rowspan=1 colspan=1>Case No.:</td><td rowspan=1 colspan=1>Date and time warrant executed:</td><td rowspan=1 colspan=1>Copy of warrant and inventory left with:</td></tr><tr><td rowspan=1 colspan=3>Inventory made in the presence of :</td></tr><tr><td rowspan=1 colspan=3>Certification</td></tr><tr><td rowspan=1 colspan=3>I declare under penalty of perjury that this inventory is coect and was returned along with the original warantto the Court.Date:Executing officer&#x27;s signaturePrinted name and title</td></tr></table>
...
This warant authorizes the seizure of certain evidence, fruits, and instrumentalities of violations of Title 18, United States Code, Sections 1591 (sex trafficking of minors), and 371 (sex trafficking conspiracy) (the "Subject Offenses") described as follows:

1. Any documents or communications with or regarding victims or potential victims of the Subject Offenses;

2. Any photographs of victims or potential victims of the Subject Offnses;

3. Any nude, partially nude, or sexually suggestive photographs of individuals who appear to be teenage girls, or younger;

4. Motion pictures, films, videos, and other recordings of visual or written depictions of minors engaged in sexually explicit conduct, as defined in 18 U.S.C. s 2256(2);
...
conducting a file-by-file review by "pening" or reading the first few "pages" of such files in order to determine their precise contents (analogous to performing a cursory examination of each document in a file cabinet to determine its relevance);

"scanning"” storage areas to discover and posibly recover recently deleted data or deliberately hidden files; and
...
reviewing metadat,system information,configurationfiles,registydata,and ay other information refl ecting how, when, and by whom the computer was used.
